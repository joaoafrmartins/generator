...
Base.prototype.run = function run(args, cb) {
  ...
  // Ensure a prototype method is candidate to be runned by default
 ...
 * @param  {Generator} Generator  The generator to compose with.
...
Base.prototype.composeWith = function composeWith(Generator, options, settings) {
  var generator = this.env.instantiate(Generator, options);
